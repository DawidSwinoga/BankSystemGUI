...
public class Database {
    ...
    public Database(String hibernateCfgPath) {
        Configuration configuration = new Configuration().configure(HibernateUtil.class.getResource(hibernateCfgPath));
    ...
    public void transfer(Account sourceAccount, Account destinationAccount, double amount) throws NotEnoughtMoneyToTransactionException {
        if (!sourceAccount.getClientNumber().equals(destinationAccount.getClientNumber())) {
            Session session = sessionFactory.openSession();
            Transaction tx = null;
